...
export default function WhoWantsToWinBraggingRights({ stage }: { stage: 'start' | 'game' | 'win' }) {
    ...
    return (
        <div id="mainLogo" className="animate-slide-in text-center">
            <div className="w-[345px] md:w-[732px] bg-black/30 backdrop-blur-sm text-white text-center rounded-t-full mb-4">
            ...
            <div className="w-[345px] md:w-[732px] bg-black/30 backdrop-blur-sm text-white text-center rounded-b-full mb-4">
